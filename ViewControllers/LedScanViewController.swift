...
class LedScanViewController: UIViewController {
  ...
  static func route() -> UIViewController {
    ...
    guard let vc = storyboard.instantiateViewController(identifier: "BarCodeScanViewController") as? LedScanViewController else {
